...
<body class="bg-dark text-light">
	<div class="container">
		...
		<main>
			<section>
				<a href="formularioCliente.jsp?id_cliente=-1"><button
						class="btn btn-success">Novo Cliente</button></a>
			</section>
			<section>
				<table class="table bg-light mt-3">
					...
					%>
						<tr>
							<td><% out.write(id); %></td>
							<td><% out.write(nomeCliente); %></td>
							<td><% out.write(idade); %></td>
							<td><% out.write(situacaoDesc); %></td>
							<td><a href="formularioCliente.jsp?id_cliente=<% out.write(id); %>">
									<button type="button" class="btn btn-primary">Editar</button>
							</a> <a href="excluirCliente.jsp?id_cliente=<% out.write(id); %>">
